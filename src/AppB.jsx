...
const CATS = [
  "すべて","アルゴリズム・プログラミング","情報セキュリティ",
];

const ALL_QUESTIONS = [{"id":1,"cat":"アルゴリズム・プログラミング","topic":"変数の入れ替え(swap)トレース","q":"次の疑似言語プログラムを実行した直後のxとyの値の組合せはどれか。","choices":[{"label":"ア","text":"x=8, y=8"},{"label":"イ","text":"x=8, y=5"},{"label":"ウ","text":"x=5, y=8"},{"label":"エ","text":"x=5, y=5"}],"correct":"イ","hint":"tに退避したxの値(5)を最後にyへ代入するため、x=8, y=5となる。","code":"○整数型: x ← 5\n○整数型: y ← 8\n○整数型: t\nt ← x\nx ← y\ny ← t"},{"id":2,"cat":"アルゴリズム・プログラミング","topic":"if-elseif-else文のトレース","q":"次の疑似言語プログラムを実行したとき、resultに代入される値はどれか。","choices":[{"label":"ア","text":"\"A\""},{"label":"イ","text":"\"C\""},{"label":"ウ","text":"\"B\""},{"label":"エ","text":"\"D\""}],"correct":"ウ","hint":"scoreは90未満だが70以上なので、2番目の条件が成立しresultは\"B\"になる。","code":"○整数型: score ← 72\n○文字列型: result\nif (score ≥ 90) then\n    result ← \"A\"\nelseif (score ≥ 70) then\n    result ← \"B\"\nelseif (score ≥ 50) then\n    result ← \"C\"\nelse\n    result ← \"D\"\nendif"},{"id":3,"cat":"アルゴリズム・プログラミング","topic":"ネストしたif文のトレース","q":"次の疑似言語プログラムを実行したとき、resultに代入される値はどれか。","choices":[{"label":"ア","text":"3"},{"label":"イ","text":"1"},{"label":"ウ","text":"2"},{"label":"エ","text":"4"}],"correct":"ア","hint":"a>bがfalse(4>7は成立しない)なので、外側のelse節が実行されresultは3になる。","code":"○整数型: a ← 4\n○整数型: b ← 7\n○整数型: result\nif (a > b) then\n    if (a > 10) then\n        result ← 1\n    else\n        result ← 2\n    endif\nelse\n    result ← 3\nendif"},{"id":4,"cat":"アルゴリズム・プログラミング","topic":"論理積(and)を使った条件式のトレース","q":"次の疑似言語プログラムを実行したとき、resultに代入される値はどれか。","choices":[{"label":"ア","text":"エラーになる"},{"label":"イ","text":"\"TT\""},{"label":"ウ","text":"\"F\""},{"label":"エ","text":"\"T\""}],"correct":"エ","hint":"x>0(真)かつy>10(真)なので、and条件全体が真となりresultは\"T\"になる。","code":"○整数型: x ← 5\n○整数型: y ← 15\n○文字列型: result\nif (x > 0 and y > 10) then\n    result ← \"T\"\nelse\n    result ← \"F\"\nendif"},{"id":5,"cat":"アルゴリズム・プログラミング","topic":"論理否定(not)を使った条件式のトレース","q":"次の疑似言語プログラムを実行したとき、resultに代入される値はどれか。","choices":[{"label":"ア","text":"\"B\""},{"label":"イ","text":"false"},{"label":"ウ","text":"true"},{"label":"エ","text":"\"A\""}],"correct":"ア","hint":"flagはtrueなので、not flagはfalseとなりelse節が実行されresultは\"B\"になる。","code":"○論理型: flag ← true\n○文字列型: result\nif (not flag) then\n    result ← \"A\"\nelse\n    result ← \"B\"\nendif"},{"id":6,"cat":"アルゴリズム・プログラミング","topic":"剰余演算子を使った偶奇判定のトレース","q":"次の疑似言語プログラムを実行したとき、resultに代入される値はどれか。","choices":[{"label":"ア","text":"\"0\""},{"label":"イ","text":"\"偶数\""},{"label":"ウ","text":"\"奇数\""},{"label":"エ","text":"\"6\""}],"correct":"イ","hint":"6を2で割った余りは0なので、条件が成立しresultは\"偶数\"になる。","code":"○整数型: n ← 6\n○文字列型: result\nif (n mod 2 = 0) then\n    result ← \"偶数\"\nelse\n    result ← \"奇数\"\nendif"},{"id":7,"cat":"アルゴリズム・プログラミング","topic":"forループによる合計計算のトレース","q":"次の疑似言語プログラムを実行した直後のsumの値はどれか。","choices":[{"label":"ア","text":"120"},{"label":"イ","text":"20"},{"label":"ウ","text":"15"},{"label":"エ","text":"10"}],"correct":"ウ","hint":"1+2+3+4+5=15である。20は誤って6まで加えた場合、120は積(階乗)の値。","code":"○整数型: sum ← 0\nfor (i を 1 から 5 まで 1 ずつ増やす)\n    sum ← sum + i\nendfor"},{"id":8,"cat":"アルゴリズム・プログラミング","topic":"forループによる積(階乗)計算のトレース","q":"次の疑似言語プログラムを実行した直後のprodの値はどれか。","choices":[{"label":"ア","text":"16"},{"label":"イ","text":"120"},{"label":"ウ","text":"10"},{"label":"エ","text":"24"}],"correct":"エ","hint":"1×1×2×3×4=24であり、これは4の階乗(4!)に等しい。","code":"○整数型: prod ← 1\nfor (i を 1 から 4 まで 1 ずつ増やす)\n    prod ← prod × i\nendfor"},{"id":9,"cat":"アルゴリズム・プログラミング","topic":"whileループと整数除算のトレース","q":"次の疑似言語プログラム(÷は小数点以下切り捨ての整数除算とする)を実行した直後のcountの値はどれか。","choices":[{"label":"ア","text":"4"},{"label":"イ","text":"10"},{"label":"ウ","text":"5"},{"label":"エ","text":"3"}],"correct":"ア","hint":"20→10→5→2→1と4回の除算でn≤1となるため、countは4になる。","code":"○整数型: n ← 20\n○整数型: count ← 0\nwhile (n > 1)\n    n ← n ÷ 2\n    count ← count + 1\nendwhile"},{"id":10,"cat":"アルゴリズム・プログラミング","topic":"for文の減少ループと偶数合計のトレース","q":"次の疑似言語プログラムを実行した直後のsumの値はどれか。","choices":[{"label":"ア","text":"20"},{"label":"イ","text":"25"},{"label":"ウ","text":"30"},{"label":"エ","text":"55"}],"correct":"ウ","hint":"10から1までの偶数2,4,6,8,10の合計は2+4+6+8+10=30である。","code":"○整数型: sum ← 0\nfor (i を 10 から 1 まで 1 ずつ減らす)\n    if (i mod 2 = 0) then\n        sum ← sum + i\n    endif\nendfor"},{"id":11,"cat":"アルゴリズム・プログラミング","topic":"二重ループの反復回数のトレース","q":"次の疑似言語プログラムを実行した直後のcountの値はどれか。","choices":[{"label":"ア","text":"6"},{"label":"イ","text":"3"},{"label":"ウ","text":"12"},{"label":"エ","text":"9"}],"correct":"エ","hint":"外側3回×内側3回で、countは3×3=9回加算される。","code":"○整数型: count ← 0\nfor (i を 1 から 3 まで 1 ずつ増やす)\n    for (j を 1 から 3 まで 1 ずつ増やす)\n        count ← count + 1\n    endfor\nendfor"},{"id":12,"cat":"アルゴリズム・プログラミング","topic":"do-while文(後判定ループ)のトレース","q":"次の疑似言語プログラムを実行した直後のcountの値はどれか。","choices":[{"label":"ア","text":"10"},{"label":"イ","text":"4"},{"label":"ウ","text":"5"},{"label":"エ","text":"3"}],"correct":"イ","hint":"x: 10→7→4→1→-2 と4回減算した時点でx>0がfalseになるため、countは4になる(後判定なので必ず1回は実行される)。","code":"○整数型: x ← 10\n○整数型: count ← 0\ndo\n    x ← x - 3\n    count ← count + 1\nwhile (x > 0)"},{"id":13,"cat":"アルゴリズム・プログラミング","topic":"forループと3の倍数の合計のトレース","q":"次の疑似言語プログラムを実行した直後のsumの値はどれか。","choices":[{"label":"ア","text":"18"},{"label":"イ","text":"9"},{"label":"ウ","text":"27"},{"label":"エ","text":"55"}],"correct":"ア","hint":"1から10のうち3の倍数は3,6,9であり、合計は3+6+9=18である。","code":"○整数型: sum ← 0\nfor (i を 1 から 10 まで 1 ずつ増やす)\n    if (i mod 3 = 0) then\n        sum ← sum + i\n    endif\nendfor"},{"id":14,"cat":"アルゴリズム・プログラミング","topic":"forループの増分を変えた場合の反復回数のトレース","q":"次の疑似言語プログラムを実行した直後のsumの値はどれか。","choices":[{"label":"ア","text":"4"},{"label":"イ","text":"6"},{"label":"ウ","text":"5"},{"label":"エ","text":"21"}],"correct":"イ","hint":"iは0,4,8,12,16,20の6個の値を取るため、sumは6になる。","code":"○整数型: sum ← 0\nfor (i を 0 から 20 まで 4 ずつ増やす)\n    sum ← sum + 1\nendfor"},{"id":15,"cat":"アルゴリズム・プログラミング","topic":"配列の最大値を求める処理のトレース","q":"次の疑似言語プログラムを実行した直後のmaxの値はどれか。","choices":[{"label":"ア","text":"5"},{"label":"イ","text":"26"},{"label":"ウ","text":"7"},{"label":"エ","text":"9"}],"correct":"エ","hint":"配列Aの中で最大の値は9(A[4])であり、maxは最終的に9になる。","code":"○整数型の配列: A ← {3, 7, 2, 9, 5}\n○整数型: max ← A[1]\nfor (i を 2 から 5 まで 1 ずつ増やす)\n    if (A[i] > max) then\n        max ← A[i]\n    endif\nendfor"},{"id":16,"cat":"アルゴリズム・プログラミング","topic":"配列要素の合計と平均のトレース","q":"次の疑似言語プログラムを実行した直後のavgの値はどれか。","choices":[{"label":"ア","text":"4"},{"label":"イ","text":"20"},{"label":"ウ","text":"5"},{"label":"エ","text":"6"}],"correct":"ウ","hint":"配列の合計は4+8+6+2=20であり、20÷4=5がavgになる。","code":"○整数型の配列: A ← {4, 8, 6, 2}\n○整数型: sum ← 0\nfor (i を 1 から 4 まで 1 ずつ増やす)\n    sum ← sum + A[i]\nendfor\n○整数型: avg ← sum ÷ 4"},{"id":17,"cat":"アルゴリズム・プログラミング","topic":"配列要素の入れ替え(先頭と末尾)のトレース","q":"次の疑似言語プログラムを実行した直後の配列Aの状態はどれか。","choices":[{"label":"ア","text":"{5, 2, 3, 4, 1}"},{"label":"イ","text":"{5, 4, 3, 2, 1}"},{"label":"ウ","text":"{1, 2, 3, 4, 5}"},{"label":"エ","text":"{1, 5, 3, 4, 2}"}],"correct":"ア","hint":"先頭要素(1)と末尾要素(5)だけが入れ替わり、中間の要素は変化しない。","code":"○整数型の配列: A ← {1, 2, 3, 4, 5}\n○整数型: t\nt ← A[1]\nA[1] ← A[5]\nA[5] ← t"},{"id":18,"cat":"アルゴリズム・プログラミング","topic":"配列中の特定要素の出現回数を数える処理のトレース","q":"次の疑似言語プログラムを実行した直後のcountの値はどれか。","choices":[{"label":"ア","text":"6"},{"label":"イ","text":"2"},{"label":"ウ","text":"4"},{"label":"エ","text":"3"}],"correct":"エ","hint":"配列Aの中で値2は3回(A[1], A[3], A[5])出現するため、countは3になる。","code":"○整数型の配列: A ← {2, 5, 2, 8, 2, 3}\n○整数型: count ← 0\nfor (i を 1 から 6 まで 1 ずつ増やす)\n    if (A[i] = 2) then\n        count ← count + 1\n    endif\nendfor"},{"id":19,"cat":"アルゴリズム・プログラミング","topic":"配列の最小値のインデックスを求める処理のトレース","q":"次の疑似言語プログラムを実行した直後のminIdxの値はどれか(先頭を1番目とする)。","choices":[{"label":"ア","text":"3"},{"label":"イ","text":"4"},{"label":"ウ","text":"1"},{"label":"エ","text":"2"}],"correct":"イ","hint":"配列Aの最小値1はA[4]に格納されているため、minIdxは最終的に4になる。","code":"○整数型の配列: A ← {9, 3, 7, 1, 5}\n○整数型: minIdx ← 1\nfor (i を 2 から 5 まで 1 ずつ増やす)\n    if (A[i] < A[minIdx]) then\n        minIdx ← i\n    endif\nendfor"},{"id":20,"cat":"アルゴリズム・プログラミング","topic":"配列の反転処理のトレース","q":"次の疑似言語プログラムを実行した直後の配列Bの状態はどれか。","choices":[{"label":"ア","text":"{20, 10, 30}"},{"label":"イ","text":"{0, 0, 0}"},{"label":"ウ","text":"{30, 20, 10}"},{"label":"エ","text":"{10, 20, 30}"}],"correct":"ウ","hint":"B[1]←A[3]=30, B[2]←A[2]=20, B[3]←A[1]=10となり、Aを反転した配列がBになる。","code":"○整数型の配列: A ← {10, 20, 30}\n○整数型の配列: B ← {0, 0, 0}\nfor (i を 1 から 3 まで 1 ずつ増やす)\n    B[i] ← A[4 - i]\nendfor"},{"id":21,"cat":"アルゴリズム・プログラミング","topic":"再帰による階乗計算のトレース","q":"次の疑似言語で定義された手続きfactorialについて、factorial(4)の戻り値はどれか。","choices":[{"label":"ア","text":"120"},{"label":"イ","text":"16"},{"label":"ウ","text":"24"},{"label":"エ","text":"10"}],"correct":"ウ","hint":"factorial(4)=4×3×2×1=24であり、これは4の階乗の値と一致する。","code":"○整数型: 手続き factorial(整数型: n)\n  if (n ≤ 1) then\n      return 1\n  else\n      return n × factorial(n - 1)\n  endif"},{"id":22,"cat":"アルゴリズム・プログラミング","topic":"再帰によるフィボナッチ数列計算のトレース","q":"次の疑似言語で定義された手続きfibについて、fib(5)の戻り値はどれか。","choices":[{"label":"ア","text":"5"},{"label":"イ","text":"13"},{"label":"ウ","text":"8"},{"label":"エ","text":"3"}],"correct":"ア","hint":"fib(0)=0, fib(1)=1, fib(2)=1, fib(3)=2, fib(4)=3, fib(5)=5と順に求まる。","code":"○整数型: 手続き fib(整数型: n)\n  if (n ≤ 1) then\n      return n\n  else\n      return fib(n - 1) + fib(n - 2)\n  endif"},{"id":23,"cat":"アルゴリズム・プログラミング","topic":"再帰による総和計算のトレース","q":"次の疑似言語で定義された手続きsumToについて、sumTo(6)の戻り値はどれか。","choices":[{"label":"ア","text":"20"},{"label":"イ","text":"36"},{"label":"ウ","text":"15"},{"label":"エ","text":"21"}],"correct":"エ","hint":"6+5+4+3+2+1+0=21であり、1からnまでの総和を再帰的に求める処理である。","code":"○整数型: 手続き sumTo(整数型: n)\n  if (n = 0) then\n      return 0\n  else\n      return n + sumTo(n - 1)\n  endif"},{"id":24,"cat":"アルゴリズム・プログラミング","topic":"再帰呼び出しの回数の理解","q":"問21のfactorial(整数型n)の定義において、factorial(5)を呼び出したときに発生する関数呼び出しの総回数(最初の呼び出しを含む)はどれか。","choices":[{"label":"ア","text":"4回"},{"label":"イ","text":"5回"},{"label":"ウ","text":"6回"},{"label":"エ","text":"120回"}],"correct":"イ","hint":"factorial(5)→(4)→(3)→(2)→(1)の順に呼び出され、合計5回の呼び出しが発生する。","code":"○整数型: 手続き factorial(整数型: n)\n  if (n ≤ 1) then\n      return 1\n  else\n      return n × factorial(n - 1)\n  endif"},{"id":25,"cat":"アルゴリズム・プログラミング","topic":"選択ソート1パス目のトレース","q":"配列A ← {5, 2, 8, 1, 9}に対して、未整列部分から最小値を探して先頭要素と交換する選択ソートを1回(1パス目)実行した直後の配列Aの状態はどれか。","choices":[{"label":"ア","text":"{2, 5, 8, 1, 9}"},{"label":"イ","text":"{1, 2, 8, 5, 9}"},{"label":"ウ","text":"{5, 2, 8, 1, 9}"},{"label":"エ","text":"{1, 5, 8, 2, 9}"}],"correct":"イ","hint":"配列全体の最小値1(4番目の要素)を探し出し、先頭の5と交換する。","code":"(未整列部分{5,2,8,1,9}から最小値を探し、先頭と交換する処理を1回実行)"},{"id":26,"cat":"アルゴリズム・プログラミング","topic":"バブルソート1パス目のトレース","q":"配列A ← {5, 3, 8, 1}に対して、隣接する要素を先頭から順に比較し、左が右より大きい場合に交換するバブルソートを1回(1パス)走査した直後の配列Aの状態はどれか。","choices":[{"label":"ア","text":"{1, 3, 5, 8}"},{"label":"イ","text":"{3, 1, 5, 8}"},{"label":"ウ","text":"{3, 5, 1, 8}"},{"label":"エ","text":"{5, 3, 8, 1}"}],"correct":"ウ","hint":"(5,3)は交換→{3,5,8,1}、(5,8)は交換不要、(8,1)は交換→{3,5,1,8}となる。","code":"(隣接要素を(A[1],A[2])→(A[2],A[3])→(A[3],A[4])の順に比較・交換する処理を1回実行)"},{"id":27,"cat":"アルゴリズム・プログラミング","topic":"挿入ソートの部分的な整列状態のトレース","q":"配列A ← {4, 2, 7, 1, 3}に対して挿入ソートを適用し、先頭2要素の整列が完了した直後の配列Aの状態はどれか。","choices":[{"label":"ア","text":"{2, 4, 7, 1, 3}"},{"label":"イ","text":"{4, 2, 7, 1, 3}"},{"label":"ウ","text":"{4, 7, 2, 1, 3}"},{"label":"エ","text":"{2, 4, 1, 3, 7}"}],"correct":"ア","hint":"先頭2要素{4,2}を整列すると{2,4}になり、残りの要素はまだ手つかずのままとなる。","code":"(先頭2要素{4,2}を挿入ソートで整列する処理までを実行)"},{"id":28,"cat":"アルゴリズム・プログラミング","topic":"選択ソートの必要パス回数の理解","q":"要素数6個の配列を選択ソートで完全に整列させるために必要な走査(パス)の回数は最大何回か。","choices":[{"label":"ア","text":"4回"},{"label":"イ","text":"15回"},{"label":"ウ","text":"6回"},{"label":"エ","text":"5回"}],"correct":"エ","hint":"選択ソートはn個の要素に対しn-1回のパスで整列が完了するため、6-1=5回となる。","code":"(要素数n=6の配列を選択ソートで整列する場合の必要パス数を考える)"},{"id":29,"cat":"アルゴリズム・プログラミング","topic":"線形探索のトレース","q":"配列A ← {7, 3, 9, 1, 5}に対して先頭から順にkey=9を探す線形探索を行うとき、配列の何番目の要素で一致が見つかるか(先頭を1番目とする)。","choices":[{"label":"ア","text":"1番目"},{"label":"イ","text":"2番目"},{"label":"ウ","text":"4番目"},{"label":"エ","text":"3番目"}],"correct":"エ","hint":"A[3]=9であるため、3番目の要素で一致が見つかる。","code":"(先頭からA[1],A[2],…の順にkey=9と比較していく)"},{"id":30,"cat":"アルゴリズム・プログラミング","topic":"二分探索の最初の比較対象のトレース","q":"昇順に整列済みの配列A ← {1, 3, 5, 7, 9, 11, 13}(要素数7)に対してkey=11を二分探索するとき、最初に比較される中央の要素の値はどれか。","choices":[{"label":"ア","text":"7"},{"label":"イ","text":"11"},{"label":"ウ","text":"9"},{"label":"エ","text":"5"}],"correct":"ア","hint":"中央の添字は(1+7)÷2=4(切り捨て)であり、A[4]=7が最初の比較対象になる。","code":"(中央位置 = (1+7) を 2 で割った値(小数点以下切り捨て) を添字として最初の比較を行う)"},{"id":31,"cat":"アルゴリズム・プログラミング","topic":"二分探索の比較回数のトレース","q":"問30と同じ配列A ← {1, 3, 5, 7, 9, 11, 13}に対してkey=11を二分探索する場合、keyが見つかるまでに必要な比較回数はどれか。","choices":[{"label":"ア","text":"3回"},{"label":"イ","text":"2回"},{"label":"ウ","text":"1回"},{"label":"エ","text":"4回"}],"correct":"イ","hint":"1回目の比較(A[4]=7)で右半分に絞り込み、2回目の比較(A[6]=11)で一致が見つかる。","code":"(1回目:A[4]=7と比較→11の方が大きいので右半分へ。2回目:右半分の中央A[6]=11と比較)"},{"id":32,"cat":"アルゴリズム・プログラミング","topic":"二分探索の適用条件の理解","q":"二分探索アルゴリズムを正しく適用するために、対象の配列があらかじめ満たしておくべき条件はどれか。","choices":[{"label":"ア","text":"配列に重複した値が存在しないこと"},{"label":"イ","text":"配列の要素が全て正の整数であること"},{"label":"ウ","text":"配列が昇順(または降順)に整列済みであること"},{"label":"エ","text":"配列の要素数が偶数であること"}],"correct":"ウ","hint":"二分探索は中央値との大小比較で探索範囲を絞り込むため、整列済みであることが前提条件となる。","code":"(二分探索の前提条件を考える)"},{"id":33,"cat":"アルゴリズム・プログラミング","topic":"文字列の長さを求める処理の理解","q":"文字列s ← \"ALGORITHM\"の文字数はどれか。","choices":[{"label":"ア","text":"9"},{"label":"イ","text":"8"},{"label":"ウ","text":"10"},{"label":"エ","text":"11"}],"correct":"ア","hint":"A-L-G-O-R-I-T-H-Mの9文字から構成される文字列である。","code":"○文字列型: s ← \"ALGORITHM\""},{"id":34,"cat":"アルゴリズム・プログラミング","topic":"文字列中の特定文字の出現回数を数える処理のトレース","q":"文字列s ← \"banana\"の中に文字'a'が出現する回数はどれか。","choices":[{"label":"ア","text":"2"},{"label":"イ","text":"3"},{"label":"ウ","text":"4"},{"label":"エ","text":"1"}],"correct":"イ","hint":"b-a-n-a-n-aの並びにおいて、'a'はb直後、n直後×2の合計3回出現する。","code":"○文字列型: s ← \"banana\"\n(sの各文字を先頭から調べ、'a'と一致する回数を数える)"},{"id":35,"cat":"アルゴリズム・プログラミング","topic":"文字列の逆順生成処理のトレース","q":"次の疑似言語プログラムを実行した直後のrevの値はどれか(sのi番目の文字はs[i]で表す)。","choices":[{"label":"ア","text":"\"CAB\""},{"label":"イ","text":"\"BCA\""},{"label":"ウ","text":"\"CBA\""},{"label":"エ","text":"\"ABC\""}],"correct":"ウ","hint":"i=3,2,1の順にs[3]=\"C\", s[2]=\"B\", s[1]=\"A\"を連結するため、revは\"CBA\"になる。","code":"○文字列型: s ← \"ABC\"\n○文字列型: rev ← \"\"\nfor (i を 3 から 1 まで 1 ずつ減らす)\n    rev ← rev + s[i]\nendfor"},{"id":36,"cat":"アルゴリズム・プログラミング","topic":"スタックのpush/pop操作のトレース","q":"空のスタックに対してpush(1), push(2), push(3), pop(), push(4), pop()の順に操作を行った。最後のpop()で取り出される値はどれか。","choices":[{"label":"ア","text":"2"},{"label":"イ","text":"1"},{"label":"ウ","text":"3"},{"label":"エ","text":"4"}],"correct":"エ","hint":"push1,2,3で[1,2,3]。pop()で3が取り出され[1,2]。push4で[1,2,4]。最後のpop()で4が取り出される。","code":"(スタックはLIFO(後入れ先出し)の構造である)"},{"id":37,"cat":"アルゴリズム・プログラミング","topic":"キューのenqueue/dequeue操作のトレース","q":"空のキューに対してenqueue(A), enqueue(B), enqueue(C), dequeue(), enqueue(D)の順に操作を行った直後の、キューの中身を先頭から順に並べたものはどれか。","choices":[{"label":"ア","text":"B, C, D"},{"label":"イ","text":"A, B, C"},{"label":"ウ","text":"A, B, C, D"},{"label":"エ","text":"D, C, B"}],"correct":"ア","hint":"enqueueでA,B,Cが順に入り、dequeue()で先頭のAが取り出され[B,C]。enqueue(D)で[B,C,D]になる。","code":"(キューはFIFO(先入れ先出し)の構造である)"},{"id":38,"cat":"アルゴリズム・プログラミング","topic":"スタックを用いた逆ポーランド記法の評価のトレース","q":"逆ポーランド記法で書かれた式「3 4 + 2 ×」を、スタックを用いて左から順に評価した結果はどれか。","choices":[{"label":"ア","text":"10"},{"label":"イ","text":"14"},{"label":"ウ","text":"20"},{"label":"エ","text":"11"}],"correct":"イ","hint":"3,4をpush後+で3+4=7をpush。2をpush後×で7×2=14をpush。最終結果は14になる。","code":"(数値はスタックにpushし、演算子が来たらスタックから2つpopして演算し結果をpushする)"},{"id":39,"cat":"情報セキュリティ","topic":"総当たり攻撃の識別","q":"不正アクセスを試みる攻撃者が、あらゆる文字の組合せを総当たりで試行してパスワードを解析しようとする攻撃はどれか。","choices":[{"label":"ア","text":"フィッシング"},{"label":"イ","text":"DoS攻撃"},{"label":"ウ","text":"ブルートフォース攻撃"},{"label":"エ","text":"SQLインジェクション"}],"correct":"ウ","hint":"文字数やログイン試行回数の制限が有効な対策となる。"},{"id":40,"cat":"情報セキュリティ","topic":"フィッシング詐欺の識別","q":"実在する金融機関等を装った偽のWebサイトへ利用者を誘導し、IDやパスワードを入力させて盗み取る攻撃はどれか。","choices":[{"label":"ア","text":"DoS攻撃"},{"label":"イ","text":"ブルートフォース攻撃"},{"label":"ウ","text":"ワーム"},{"label":"エ","text":"フィッシング"}],"correct":"エ","hint":"メールやSMSに偽サイトへのリンクを記載して誘導する手口が典型的である。"},{"id":41,"cat":"情報セキュリティ","topic":"ワームの識別","q":"電子メールの添付ファイルなどを介して感染し、他のコンピュータへ自己増殖(自己複製)しながら拡散する不正プログラムはどれか。","choices":[{"label":"ア","text":"ウイルス(宿主必須型)"},{"label":"イ","text":"スパイウェア"},{"label":"ウ","text":"ワーム"},{"label":"エ","text":"アドウェア"}],"correct":"ウ","hint":"宿主となるファイルに寄生するウイルスと異なり、単独で自己増殖できる点が特徴。"},{"id":42,"cat":"情報セキュリティ","topic":"多要素認証の識別","q":"IDとパスワードに加えて、スマートフォンに送信されたワンタイムコードの入力を求める認証方式は、一般に何と呼ばれるか。","choices":[{"label":"ア","text":"パスワードレス認証"},{"label":"イ","text":"生体認証単体"},{"label":"ウ","text":"シングルサインオン"},{"label":"エ","text":"二要素認証(多要素認証)"}],"correct":"エ","hint":"知識情報(パスワード)と所持情報(スマートフォン)という異なる要素を組み合わせている。"},{"id":43,"cat":"情報セキュリティ","topic":"SQLインジェクションの識別","q":"Webアプリケーションにおいて、利用者からの入力値をそのままSQL文に埋め込むことで発生する脆弱性を悪用した攻撃はどれか。","choices":[{"label":"ア","text":"SQLインジェクション"},{"label":"イ","text":"セッションハイジャック"},{"label":"ウ","text":"クロスサイトスクリプティング(XSS)"},{"label":"エ","text":"ディレクトリトラバーサル"}],"correct":"ア","hint":"プレースホルダを使ったバインド機構(プリペアドステートメント)により対策できる。"},{"id":44,"cat":"情報セキュリティ","topic":"DoS攻撃の識別","q":"大量のリクエストを送りつけてサーバの処理能力を超えさせ、サービスを利用不能に陥れる攻撃はどれか。","choices":[{"label":"ア","text":"SQLインジェクション"},{"label":"イ","text":"DoS攻撃"},{"label":"ウ","text":"フィッシング"},{"label":"エ","text":"ブルートフォース攻撃"}],"correct":"イ","hint":"多数の送信元から同時に行う場合はDDoS攻撃と呼ばれる。"},{"id":45,"cat":"情報セキュリティ","topic":"公開鍵暗号方式の鍵の使い方の理解","q":"公開鍵暗号方式において、送信者がデータを暗号化する際に使用する鍵はどれか。","choices":[{"label":"ア","text":"送信者の公開鍵"},{"label":"イ","text":"受信者の公開鍵"},{"label":"ウ","text":"送信者の秘密鍵"},{"label":"エ","text":"受信者の秘密鍵"}],"correct":"イ","hint":"受信者の公開鍵で暗号化されたデータは、対応する受信者の秘密鍵でのみ復号できる。"},{"id":46,"cat":"情報セキュリティ","topic":"ディジタル署名の目的の理解","q":"送信者がメッセージにディジタル署名を付与する主な目的はどれか。","choices":[{"label":"ア","text":"送信者の本人性の証明とメッセージの改ざん検知"},{"label":"イ","text":"メッセージ内容の暗号化による秘匿"},{"label":"ウ","text":"通信経路の暗号化"},{"label":"エ","text":"受信者の認証"}],"correct":"ア","hint":"送信者の秘密鍵で署名し、対応する公開鍵で検証することで本人性と非改ざんを確認できる。"}];
