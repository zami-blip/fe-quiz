...
const ALL_QUESTIONS = [{"id": 1, "cat": "基礎理論", "topic": "LLMのファインチューニング", "q": "大規模言語モデルを特定企業の問合せ分類に適用するため、事前学習済みモデルへ、その企業の分類済みデータを用いて追加学習を行った。この処理はどれか。", "choices": [{"label": "ア", "text": "データクレンジング"}, {"label": "イ", "text": "ファインチューニング"}, {"label": "ウ", "text": "クラスタリング"}, {"label": "エ", "text": "量子化"}], "correct": "イ", "hint": "目的別データによる追加学習はファインチューニングと呼ばれる。"}, {"id": 2, "cat": "基礎理論", "topic": "けた落ち誤差", "q": "浮動小数点演算で、絶対値がほぼ等しい二つの数を減算したところ、上位の有効数字が失われた。この誤差はどれか。", "choices": [{"label": "ア", "text": "情報落ち"}, {"label": "イ", "text": "オーバーフロー"}, {"label": "ウ", "text": "丸め誤差"}, {"label": "エ", "text": "けた落ち"}], "correct": "エ", "hint": "近い値どうしの減算で有効数字が失われる現象がけた落ちである。"}, {"id": 3, "cat": "アルゴリズム・プログラミング", "topic": "二分探索木の大小関係(図)", "q": "図の木は二分探索木である。節a～gに入る値の大小関係として正しいものはどれか。値は重複しない。", "choices": [{"label": "ア", "text": "b<a<c<m<e<f<g"}, {"label": "イ", "text": "g<f<e<m<c<b<a"}, {"label": "ウ", "text": "a<b<c<m<e<f<g"}, {"label": "エ", "text": "a<b<c<m<e<g<f"}], "correct": "ウ", "hint": "左部分木<根<右部分木の関係を各節に適用すると、中順に並べた順序がa,b,c,m,e,f,gになる。", "image": "/images/diagrams/kakomon-a-q3-tree.png"}, {"id": 4, "cat": "コンピュータシステム", "topic": "MTBF/MTTRの経年変化と稼働率", "q": "MTBFが4,500時間、MTTRが900時間の装置がある。5年後まで毎年、MTBFを150時間ずつ増やし、MTTRを100時間ずつ減らす。5年後の稼働率として最も近いものはどれか。", "choices": [{"label": "ア", "text": "0.88"}, {"label": "イ", "text": "0.93"}, {"label": "ウ", "text": "0.91"}, {"label": "エ", "text": "0.95"}], "correct": "イ", "hint": "5年後はMTBF=5,250時間、MTTR=400時間。稼働率=5,250÷(5,250+400)≒0.93となる。"}, {"id": 5, "cat": "システム開発", "topic": "ローコード開発とノーコード開発の違い", "q": "用意された画面部品をGUIで組み合わせ、必要な部分だけソースコードを書く開発方式はどれか。", "choices": [{"label": "ア", "text": "ローコード開発"}, {"label": "イ", "text": "ノーコード開発"}, {"label": "ウ", "text": "RPA"}, {"label": "エ", "text": "ウォーターフォール"}], "correct": "ア", "hint": "一部をコードで補える点がローコード開発。全くコードを書かない方式はノーコード開発である。"}, {"id": 6, "cat": "データベース", "topic": "WHERE句によるIN指定", "q": "次の商品表で、仕入先IDがM02又はM04の商品だけを得るWHERE句はどれか。\n商品ID/商品名/仕入先ID/単価\nS11/モニタ/M02/34,000　S12/マウス/M03/4,800　S13/キーボード/M04/9,500　S14/カメラ/M02/12,000", "choices": [{"label": "ア", "text": "WHERE 仕入先ID NOT IN ('M02','M04')"}, {"label": "イ", "text": "WHERE 仕入先ID='M02' AND 仕入先ID='M04'"}, {"label": "ウ", "text": "WHERE 単価 IN ('M02','M04')"}, {"label": "エ", "text": "WHERE 仕入先ID IN ('M02','M04')"}], "correct": "エ", "hint": "INは指定した候補のいずれかに一致する行を選ぶ演算子である。"}, {"id": 7, "cat": "ネットワーク", "topic": "回線利用率の計算", "q": "800Mバイトのデータに15%の制御情報を付加し、50Mビット/秒の回線で160秒かけて転送した。回線利用率はおよそ何%か。1M=10^6とする。", "choices": [{"label": "ア", "text": "80"}, {"label": "イ", "text": "69"}, {"label": "ウ", "text": "92"}, {"label": "エ", "text": "98"}], "correct": "ウ", "hint": "(800×1.15×8)÷(50×160)=0.92であり、回線利用率はおよそ92%になる。"}, {"id": 8, "cat": "ネットワーク", "topic": "HTTPSの特徴", "q": "HTTPにはなくHTTPSにある特徴として最も適切なものはどれか。", "choices": [{"label": "ア", "text": "サーバ証明書で通信相手を確認できる"}, {"label": "イ", "text": "cookieを使える"}, {"label": "ウ", "text": "URLを指定できる"}, {"label": "エ", "text": "HTMLを送受信できる"}], "correct": "ア", "hint": "HTTPSではTLSと証明書によりサーバの確認や通信の暗号化を行う。"}, {"id": 9, "cat": "情報セキュリティ", "topic": "暗号技術の危殆化", "q": "暗号技術の危殆化に該当するものはどれか。", "choices": [{"label": "ア", "text": "証明書の期限が切れた"}, {"label": "イ", "text": "利用者が秘密鍵を紛失した"}, {"label": "ウ", "text": "ハッシュ衝突を現実的時間で発見する方法が見つかった"}, {"label": "エ", "text": "暗号化ファイルを誤って削除した"}], "correct": "ウ", "hint": "方式そのものの安全性が低下することを危殆化と呼ぶ。"}, {"id": 10, "cat": "情報セキュリティ", "topic": "WAFの役割", "q": "WebアプリへのSQLインジェクションやXSSなど、HTTP通信中の攻撃パターンを検知・遮断するものはどれか。", "choices": [{"label": "ア", "text": "WAF"}, {"label": "イ", "text": "DHCP"}, {"label": "ウ", "text": "RAID"}, {"label": "エ", "text": "UPS"}], "correct": "ア", "hint": "WAFはWebアプリケーションへの通信内容を検査し、攻撃パターンを検知・遮断する。"}, {"id": 11, "cat": "データベース", "topic": "E-Rモデルのエンティティ", "q": "E-Rモデルにおけるエンティティの説明として適切なものはどれか。", "choices": [{"label": "ア", "text": "特性を表す属性をもつ"}, {"label": "イ", "text": "必ず物理的な物だけを表す"}, {"label": "ウ", "text": "関係は状態遷移だけで表す"}, {"label": "エ", "text": "1種類につきインスタンスは一つだけ"}], "correct": "ア", "hint": "エンティティは管理対象の種類であり、属性と複数のインスタンスをもつ。"}, {"id": 12, "cat": "アルゴリズム・プログラミング", "topic": "多相性(ポリモーフィズム)", "q": "異なるクラスのオブジェクトを同じインタフェースで操作し、実体に応じた異なる動作をさせる性質はどれか。", "choices": [{"label": "ア", "text": "継承"}, {"label": "イ", "text": "集約"}, {"label": "ウ", "text": "隠蔽"}, {"label": "エ", "text": "多相性"}], "correct": "エ", "hint": "同じ呼出しが実体ごとに異なる振る舞いになる性質を多相性(ポリモーフィズム)と呼ぶ。"}, {"id": 13, "cat": "システム開発", "topic": "スクラムのプロダクトオーナの役割", "q": "スクラムで、プロダクトバックログの内容と並び順に責任をもつ役割はどれか。", "choices": [{"label": "ア", "text": "開発者"}, {"label": "イ", "text": "スクラムマスタ"}, {"label": "ウ", "text": "ステークホルダ全員"}, {"label": "エ", "text": "プロダクトオーナ"}], "correct": "エ", "hint": "価値最大化とバックログ管理はプロダクトオーナの責任である。"}, {"id": 14, "cat": "プロジェクトマネジメント", "topic": "アローダイアグラムの最短所要日数(図)", "q": "図のアローダイアグラムで示すプロジェクトの最短所要日数は何日か。矢印上は作業名と日数である。", "choices": [{"label": "ア", "text": "19"}, {"label": "イ", "text": "18"}, {"label": "ウ", "text": "13"}, {"label": "エ", "text": "15"}], "correct": "イ", "hint": "S-X-Z-Tは4+6+4=14日、S-X-W-Tは4+3+6=13日、S-Y-W-Tは7+5+6=18日。最長経路である18日が全体の所要日数になる。", "image": "/images/diagrams/kakomon-a-q14-arrow.png"}, {"id": 15, "cat": "サービスマネジメント・監査", "topic": "サーバ室の物理的安全対策の監査", "q": "サーバ室の物理的安全対策を監査した。指摘事項とすべき状況はどれか。", "choices": [{"label": "ア", "text": "入退室記録を半年保存する"}, {"label": "イ", "text": "室外に用途を表示しない"}, {"label": "ウ", "text": "搬入口の扉を作業しやすいよう常時解錠する"}, {"label": "エ", "text": "無人時間帯も侵入警報が作動する"}], "correct": "ウ", "hint": "外部から侵入できる扉を常時解錠しておくのは不正侵入の危険が高く、指摘事項となる。"}, {"id": 16, "cat": "経営・戦略・法務", "topic": "マーケットバスケット分析", "q": "購買履歴から『一緒に購入されやすい商品』を発見する分析はどれか。", "choices": [{"label": "ア", "text": "PPM"}, {"label": "イ", "text": "ABC分析"}, {"label": "ウ", "text": "マーケットバスケット分析"}, {"label": "エ", "text": "回帰分析"}], "correct": "ウ", "hint": "商品の同時購入関係を求める分析がマーケットバスケット分析である。"}, {"id": 17, "cat": "経営・戦略・法務", "topic": "生成AIのオプトアウト設定", "q": "生成AIサービスのオプトアウト設定が有効なのはどのような場合か。", "choices": [{"label": "ア", "text": "入力内容をサービスの学習に利用させたくない"}, {"label": "イ", "text": "著作権を自動取得したい"}, {"label": "ウ", "text": "出力の正確性を保証したい"}, {"label": "エ", "text": "応答速度を上げたい"}], "correct": "ア", "hint": "オプトアウトは入力データをモデルの学習改善へ使わせないための設定である。"}, {"id": 18, "cat": "経営・戦略・法務", "topic": "ロングテール型物販の成立条件", "q": "ロングテール型の物販を成立させる施策として適切なものはどれか。", "choices": [{"label": "ア", "text": "全商品を実店舗に大量展示する"}, {"label": "イ", "text": "売れ筋だけに限定する"}, {"label": "ウ", "text": "地域ごとに同じ少数商品だけを扱う"}, {"label": "エ", "text": "豊富な品ぞろえと低コストな在庫・配送基盤を整える"}], "correct": "エ", "hint": "少量販売の商品を多数扱い合計売上を作るには、品ぞろえと低コストな運用基盤が必要である。"}, {"id": 19, "cat": "経営・戦略・法務", "topic": "カフェ運営の必要客数計算", "q": "表の条件でカフェを運営する。月18万円の利益を得るため、1席当たり1日平均何人の客が必要か。\n客1人当たり売上600円、客1人当たり変動費200円、固定費360,000円/月、営業日数25日/月、客席数12席", "choices": [{"label": "ア", "text": "4.0"}, {"label": "イ", "text": "4.5"}, {"label": "ウ", "text": "3.5"}, {"label": "エ", "text": "3.0"}], "correct": "イ", "hint": "必要限界利益は固定費36万+利益18万=54万円。1人当たり限界利益は600-200=400円。54万÷400÷25日÷12席=4.5人となる。"}, {"id": 20, "cat": "経営・戦略・法務", "topic": "カーボンフットプリント", "q": "カーボンフットプリントの説明として適切なものはどれか。", "choices": [{"label": "ア", "text": "商品の流通経路だけを記録する"}, {"label": "イ", "text": "製品のライフサイクル全体の温室効果ガス排出量をCO2換算する"}, {"label": "ウ", "text": "植林本数だけを表示する"}, {"label": "エ", "text": "工場の電力だけを測る"}], "correct": "イ", "hint": "原材料調達から廃棄・再資源化までの排出量をCO2換算して示す指標である。"}];
    ...
    <div style={s.app}>
      ...
      <div style={s.container}>
        <header style={s.header}>
          ...
          <div style={s.sub}>基本情報技術者 — 20問内蔵(過去問形式アレンジ演習)</div>
