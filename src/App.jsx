...
const ALL_QUESTIONS = [{"id": 1, "cat": "基礎理論", "topic": "16進数から10進数への変換", "q": "16進数1A3を10進数で表したものはどれか。", "choices": [{"label": "ア", "text": "403"}, {"label": "イ", "text": "419"}, {"label": "ウ", "text": "435"}, {"label": "エ", "text": "427"}], "correct": "イ", "hint": "1A3=1×16^2+10×16+3=256+160+3=419になる。"}, {"id": 2, "cat": "基礎理論", "topic": "排他的論理和の真理値表", "q": "論理式 A XOR B (排他的論理和)の説明として適切なものはどれか。", "choices": [{"label": "ア", "text": "AとBが等しいときだけ真になる"}, {"label": "イ", "text": "AとBの少なくとも一方が真のとき真になる"}, {"label": "ウ", "text": "AとBがともに真のときだけ真になる"}, {"label": "エ", "text": "AとBが異なるときだけ真になる"}], "correct": "エ", "hint": "排他的論理和は、AとBの値が異なるときに真(1)、同じときに偽(0)になる。"}, {"id": 3, "cat": "基礎理論", "topic": "期待値の計算", "q": "1個のさいころを1回投げるとき、出る目の期待値はどれか。", "choices": [{"label": "ア", "text": "4.5"}, {"label": "イ", "text": "4.0"}, {"label": "ウ", "text": "3.5"}, {"label": "エ", "text": "3.0"}], "correct": "ウ", "hint": "期待値=(1+2+3+4+5+6)÷6=21÷6=3.5になる。"}, {"id": 4, "cat": "基礎理論", "topic": "待ち行列理論(M/M/1モデル)", "q": "M/M/1モデルの待ち行列理論において、利用率(ρ)が1に近づくにつれて平均待ち時間はどのように変化するか。", "choices": [{"label": "ア", "text": "0に収束する"}, {"label": "イ", "text": "一定を保つ"}, {"label": "ウ", "text": "急激に増大する"}, {"label": "エ", "text": "徐々に減少する"}], "correct": "ウ", "hint": "M/M/1モデルでは、利用率が1に近づくほど平均待ち時間は急激に増大することが知られている。"}, {"id": 5, "cat": "基礎理論", "topic": "アルゴリズムの計算量比較", "q": "データ件数nが大きくなるにつれて、O(n)のアルゴリズムとO(n^2)のアルゴリズムの処理時間の差はどのようになるか。", "choices": [{"label": "ア", "text": "nが大きくなるほど差は急激に広がる"}, {"label": "イ", "text": "nによらず常に一定の差である"}, {"label": "ウ", "text": "nが大きくなるほど差は縮まる"}, {"label": "エ", "text": "nが小さいときだけ差が生じる"}], "correct": "ア", "hint": "nが大きくなるほどO(n^2)の増加が急激になり、O(n)との差は広がっていく。"}, {"id": 6, "cat": "コンピュータシステム", "topic": "パイプライン処理のクロック数計算", "q": "パイプラインなしでは1命令の実行に5クロックかかる処理を、5段のパイプラインで10命令連続して実行する場合、理想的には合計何クロックかかるか。", "choices": [{"label": "ア", "text": "14"}, {"label": "イ", "text": "10"}, {"label": "ウ", "text": "30"}, {"label": "エ", "text": "50"}], "correct": "ア", "hint": "パイプラインでは、最初の1命令に5クロック、以降は1クロックずつ増えるため、5+(10-1)×1=14クロックになる。"}, {"id": 7, "cat": "コンピュータシステム", "topic": "RAID5の実効容量計算", "q": "1台300GBのディスク4台でRAID5を構成した場合の実効容量は何GBか。", "choices": [{"label": "ア", "text": "900"}, {"label": "イ", "text": "600"}, {"label": "ウ", "text": "300"}, {"label": "エ", "text": "1200"}], "correct": "ア", "hint": "RAID5はn台のうち1台分をパリティに使うため、実効容量は(4-1)×300=900GBになる。"}, {"id": 8, "cat": "コンピュータシステム", "topic": "キャッシュメモリの実効アクセス時間の計算", "q": "キャッシュのヒット率が95%、キャッシュのアクセス時間が5ナノ秒、主記憶のアクセス時間が60ナノ秒のとき、実効アクセス時間は何ナノ秒か。", "choices": [{"label": "ア", "text": "5.75"}, {"label": "イ", "text": "6.75"}, {"label": "ウ", "text": "7.75"}, {"label": "エ", "text": "8.75"}], "correct": "ウ", "hint": "実効アクセス時間=0.95×5+0.05×60=4.75+3=7.75ナノ秒になる。"}, {"id": 9, "cat": "コンピュータシステム", "topic": "直列・並列システムの稼働率計算", "q": "稼働率0.9の装置を2台直列に接続したシステムと、2台並列に接続したシステムの稼働率について正しいものはどれか。", "choices": [{"label": "ア", "text": "直列も並列も0.9"}, {"label": "イ", "text": "直列は0.81、並列は0.99"}, {"label": "ウ", "text": "直列は0.99、並列は0.81"}, {"label": "エ", "text": "直列は0.9、並列は1.0"}], "correct": "イ", "hint": "直列の稼働率は0.9×0.9=0.81、並列の稼働率は1-(1-0.9)×(1-0.9)=0.99になる。"}, {"id": 10, "cat": "コンピュータシステム", "topic": "アドレスバスのビット数と最大アドレス空間", "q": "アドレスバスが20ビットのコンピュータが直接アドレス指定できる最大の記憶空間はどれか。", "choices": [{"label": "ア", "text": "1,048,576バイト"}, {"label": "イ", "text": "65,536バイト"}, {"label": "ウ", "text": "1,024バイト"}, {"label": "エ", "text": "4,294,967,296バイト"}], "correct": "ア", "hint": "20ビットで表現できるアドレス数は2^20=1,048,576通りになる。"}, {"id": 11, "cat": "ネットワーク", "topic": "回線速度からの転送時間の計算", "q": "500Mバイトのデータを100Mビット/秒の回線で転送するのに理論上かかる時間は何秒か。1M=10^6とする。", "choices": [{"label": "ア", "text": "80"}, {"label": "イ", "text": "4"}, {"label": "ウ", "text": "20"}, {"label": "エ", "text": "40"}], "correct": "エ", "hint": "500Mバイト=4,000Mビットであり、100Mビット/秒の回線では4,000÷100=40秒かかる。"}, {"id": 12, "cat": "ネットワーク", "topic": "サブネットにおける使用可能ホスト数の計算", "q": "サブネットマスクが/28であるネットワークにおいて、割り当て可能なホストアドレスの最大数はどれか。", "choices": [{"label": "ア", "text": "14"}, {"label": "イ", "text": "30"}, {"label": "ウ", "text": "62"}, {"label": "エ", "text": "6"}], "correct": "ア", "hint": "/28はホスト部が4ビットであり、ネットワークアドレスとブロードキャストアドレスを除くと2^4-2=14個になる。"}, {"id": 13, "cat": "ネットワーク", "topic": "CIDR表記のホスト数", "q": "192.168.1.0/24のネットワークにおいて、割り当て可能なホストの最大数はどれか。", "choices": [{"label": "ア", "text": "256"}, {"label": "イ", "text": "126"}, {"label": "ウ", "text": "510"}, {"label": "エ", "text": "254"}], "correct": "エ", "hint": "/24はホスト部が8ビットであり、2^8-2=254個のホストアドレスが割り当て可能である。"}, {"id": 14, "cat": "ネットワーク", "topic": "TCPとUDPの違い", "q": "TCPとUDPの違いに関する説明として適切なものはどれか。", "choices": [{"label": "ア", "text": "TCPとUDPはどちらも暗号化通信を保証する"}, {"label": "イ", "text": "TCPはコネクションレス型、UDPはコネクション型である"}, {"label": "ウ", "text": "UDPは必ずTCPより信頼性が高い"}, {"label": "エ", "text": "TCPはコネクション型で信頼性の高い通信を提供し、UDPはコネクションレス型で高速だが信頼性は低い"}], "correct": "エ", "hint": "TCPは確認応答や再送制御を行うコネクション型プロトコルであり、UDPはそれらを行わない軽量なコネクションレス型プロトコルである。"}, {"id": 15, "cat": "ネットワーク", "topic": "VLANの効果", "q": "1台の物理スイッチ上でVLANを設定する主な効果はどれか。", "choices": [{"label": "ア", "text": "回線の伝送速度が向上する"}, {"label": "イ", "text": "ケーブルの本数を必ず削減できる"}, {"label": "ウ", "text": "IPアドレスが自動的に割り当てられる"}, {"label": "エ", "text": "物理的な配線を増やさずに論理的にネットワークを分割できる"}], "correct": "エ", "hint": "VLANは物理構成を変えずに、論理的にブロードキャストドメインを分割できる技術である。"}, {"id": 16, "cat": "情報セキュリティ", "topic": "リスク対応の四分類", "q": "情報セキュリティリスクへの対応のうち、リスクの原因となる活動自体を中止する対応はどれか。", "choices": [{"label": "ア", "text": "リスク低減"}, {"label": "イ", "text": "リスク受容"}, {"label": "ウ", "text": "リスク回避"}, {"label": "エ", "text": "リスク移転"}], "correct": "ウ", "hint": "リスク回避は、リスクの原因となる活動を中止するなどしてリスクの発生自体をなくす対応である。"}, {"id": 17, "cat": "情報セキュリティ", "topic": "総当たり攻撃にかかる時間の見積り", "q": "4桁の数字だけからなるPINコード(0000～9999)に対して、1秒間に1,000回の割合で総当たり攻撃を行う場合、全ての組み合わせを試すのに最大何秒かかるか。", "choices": [{"label": "ア", "text": "100"}, {"label": "イ", "text": "1000"}, {"label": "ウ", "text": "10"}, {"label": "エ", "text": "1"}], "correct": "ウ", "hint": "組み合わせは10,000通りであり、1秒間に1,000回試せるので、10,000÷1,000=10秒になる。"}, {"id": 18, "cat": "情報セキュリティ", "topic": "デジタル署名の検証手順", "q": "受信者がデジタル署名を検証する際に用いる鍵はどれか。", "choices": [{"label": "ア", "text": "受信者の公開鍵"}, {"label": "イ", "text": "受信者の秘密鍵"}, {"label": "ウ", "text": "送信者の公開鍵"}, {"label": "エ", "text": "送信者の秘密鍵"}], "correct": "ウ", "hint": "デジタル署名は送信者の秘密鍵で作成され、受信者は送信者の公開鍵を使って検証する。"}, {"id": 19, "cat": "情報セキュリティ", "topic": "アクセス制御リスト(ACL)の考え方", "q": "ファイアウォールにおけるアクセス制御リスト(ACL)の役割として適切なものはどれか。", "choices": [{"label": "ア", "text": "ログをリアルタイムで暗号化する"}, {"label": "イ", "text": "暗号化通信の鍵を自動生成する"}, {"label": "ウ", "text": "通過を許可または拒否する通信の条件をルールとして定義する"}, {"label": "エ", "text": "ウイルス定義ファイルを更新する"}], "correct": "ウ", "hint": "ACLは、送信元・宛先アドレスやポート番号などの条件に基づき、通信の許可・拒否を定義するルールの一覧である。"}, {"id": 20, "cat": "情報セキュリティ", "topic": "CSIRTの役割", "q": "組織内に設置されるCSIRTの主な役割として適切なものはどれか。", "choices": [{"label": "ア", "text": "セキュリティインシデントの検知・対応・調整を行う"}, {"label": "イ", "text": "ハードウェアの調達価格を交渉する"}, {"label": "ウ", "text": "全従業員の給与計算を行う"}, {"label": "エ", "text": "製品の広告戦略を立案する"}], "correct": "ア", "hint": "CSIRT(Computer Security Incident Response Team)は、セキュリティインシデントへの対応や関係機関との調整を行うチームである。"}, {"id": 21, "cat": "情報セキュリティ", "topic": "脆弱性診断とペネトレーションテストの違い", "q": "ペネトレーションテストの説明として最も適切なものはどれか。", "choices": [{"label": "ア", "text": "ソースコードを静的に解析して不備を検出する"}, {"label": "イ", "text": "従業員へのセキュリティ教育を実施する"}, {"label": "ウ", "text": "既知の脆弱性を自動ツールで網羅的に洗い出す"}, {"label": "エ", "text": "実際に攻撃を試みてシステムへの侵入可否を検証する"}], "correct": "エ", "hint": "ペネトレーションテストは、実際の攻撃手法を用いてシステムに侵入できるかどうかを検証するテストである。"}, {"id": 22, "cat": "データベース", "topic": "第3正規形への正規化(推移関数従属の排除)", "q": "ある表で「社員番号→部署コード」「部署コード→部署名」という関係があるとき、第3正規形にするための操作として適切なものはどれか。", "choices": [{"label": "ア", "text": "全ての列を1つの表にまとめる"}, {"label": "イ", "text": "部署名を主キーにする"}, {"label": "ウ", "text": "社員番号を削除する"}, {"label": "エ", "text": "部署コードと部署名を別表に分離する"}], "correct": "エ", "hint": "部署名は社員番号に推移的に従属しているため、部署コードと部署名を別表に分離することで第3正規形になる。"}, {"id": 23, "cat": "データベース", "topic": "GROUP BYとHAVING句", "q": "SQLにおいて、グループ化した後の集計結果に対して条件を指定する句はどれか。", "choices": [{"label": "ア", "text": "GROUP BY句"}, {"label": "イ", "text": "WHERE句"}, {"label": "ウ", "text": "HAVING句"}, {"label": "エ", "text": "ORDER BY句"}], "correct": "ウ", "hint": "HAVING句は、GROUP BYで集計した後のグループに対して絞り込み条件を指定する。"}, {"id": 24, "cat": "データベース", "topic": "排他制御のロック粒度", "q": "データベースの排他制御において、ロックの粒度を表全体からレコード単位に細かくすることの効果として適切なものはどれか。", "choices": [{"label": "ア", "text": "ロックの管理コストは常にゼロになる"}, {"label": "イ", "text": "同時実行性は必ず低下する"}, {"label": "ウ", "text": "同時実行性が高まるが、ロック管理のオーバーヘッドは増える"}, {"label": "エ", "text": "データの整合性が保証されなくなる"}], "correct": "ウ", "hint": "ロックの粒度を細かくすると、複数のトランザクションが同時に異なる行を更新しやすくなり同時実行性が高まるが、管理するロックの数が増えるためオーバーヘッドも増加する。"}, {"id": 25, "cat": "データベース", "topic": "障害回復のロールフォワードとロールバック", "q": "データベース障害からの回復において、コミット済みのトランザクションの更新内容をログを用いて再現する処理はどれか。", "choices": [{"label": "ア", "text": "ロールバック"}, {"label": "イ", "text": "ロールフォワード"}, {"label": "ウ", "text": "正規化"}, {"label": "エ", "text": "デッドロック検出"}], "correct": "イ", "hint": "ロールフォワードは、バックアップ以降にコミットされた更新内容をログを使って再現し、障害直前の状態に復元する処理である。"}, {"id": 26, "cat": "アルゴリズム・プログラミング", "topic": "安定ソートの定義", "q": "ソートアルゴリズムにおける「安定ソート」の説明として適切なものはどれか。", "choices": [{"label": "ア", "text": "追加のメモリ領域を必要としない"}, {"label": "イ", "text": "必ずO(n log n)で動作する"}, {"label": "ウ", "text": "同じ値をもつ要素の相対的な順序が、ソート後も保たれる"}, {"label": "エ", "text": "比較回数が常に最小になる"}], "correct": "ウ", "hint": "安定ソートとは、同じキー値をもつ要素同士の元の順序が、ソート後も変わらないソート方式のことである。"}, {"id": 27, "cat": "アルゴリズム・プログラミング", "topic": "二分探索の最大比較回数の計算", "q": "整列済みの1,024件のデータに対して二分探索を行う場合、最悪の場合の比較回数はどれか。", "choices": [{"label": "ア", "text": "512"}, {"label": "イ", "text": "10"}, {"label": "ウ", "text": "32"}, {"label": "エ", "text": "100"}], "correct": "イ", "hint": "二分探索の比較回数はlog2(データ件数)に相当し、log2(1024)=10回になる。"}, {"id": 28, "cat": "アルゴリズム・プログラミング", "topic": "後置記法(逆ポーランド記法)の評価にスタックを使う理由", "q": "後置記法(逆ポーランド記法)で書かれた数式をコンピュータが評価する際に、スタックを用いる理由として適切なものはどれか。", "choices": [{"label": "ア", "text": "文字列を逆順に表示するため"}, {"label": "イ", "text": "括弧の対応を数えるため"}, {"label": "ウ", "text": "演算子が現れるたびに直前の被演算子を取り出して計算できるため"}, {"label": "エ", "text": "メモリ使用量を必ず最小にできるため"}], "correct": "ウ", "hint": "後置記法では、被演算子をスタックに積んでおき、演算子が現れたときにスタックから取り出して計算するという処理がしやすい。"}, {"id": 29, "cat": "アルゴリズム・プログラミング", "topic": "線形探索の平均比較回数の計算", "q": "101件のデータが格納された配列に対して線形探索を行い、目的のデータが必ず存在する場合、平均的な比較回数はどれか。", "choices": [{"label": "ア", "text": "51"}, {"label": "イ", "text": "50.5"}, {"label": "ウ", "text": "101"}, {"label": "エ", "text": "1"}], "correct": "ア", "hint": "データが均等な確率でどの位置にもあると仮定すると、平均比較回数は(件数+1)÷2=(101+1)÷2=51回になる。"}, {"id": 30, "cat": "アルゴリズム・プログラミング", "topic": "動的計画法によるメモ化の考え方", "q": "フィボナッチ数列を再帰で計算する際に、計算済みの値を配列などに保存して再利用する手法を何と呼ぶか。", "choices": [{"label": "ア", "text": "仮想化"}, {"label": "イ", "text": "メモ化"}, {"label": "ウ", "text": "カプセル化"}, {"label": "エ", "text": "多重定義"}], "correct": "イ", "hint": "メモ化は、一度計算した結果を保存しておき、同じ計算が再度必要になったときに再利用する動的計画法の代表的な手法である。"}, {"id": 31, "cat": "アルゴリズム・プログラミング", "topic": "ダイクストラ法の考え方", "q": "重み付きグラフにおいて、始点から各頂点までの最短経路を求める代表的なアルゴリズムはどれか。", "choices": [{"label": "ア", "text": "ダイクストラ法"}, {"label": "イ", "text": "クイックソート"}, {"label": "ウ", "text": "ハッシュ法"}, {"label": "エ", "text": "二分探索法"}], "correct": "ア", "hint": "ダイクストラ法は、非負の重みをもつグラフにおいて、始点から各頂点への最短経路を求める代表的なアルゴリズムである。"}, {"id": 32, "cat": "ソフトウェア・HI", "topic": "UNIX系OSのファイルアクセス権表現", "q": "UNIX系OSにおけるファイルのアクセス権表示「rwxr--r--」の説明として適切なものはどれか。", "choices": [{"label": "ア", "text": "グループだけが読み書き実行できる"}, {"label": "イ", "text": "全ての利用者が読み書き実行できる"}, {"label": "ウ", "text": "所有者だけがアクセスでき、他は一切アクセスできない"}, {"label": "エ", "text": "所有者は読み書き実行が可能で、グループとその他は読み取りのみ可能"}], "correct": "エ", "hint": "rwxr--r--は、所有者(rwx)、グループ(r--)、その他(r--)の順に権限を表しており、所有者のみ読み書き実行が可能で他は読み取りのみとなる。"}, {"id": 33, "cat": "ソフトウェア・HI", "topic": "ユーザビリティテストの目的", "q": "実際の利用者にシステムを操作してもらい、使いにくい点や問題点を発見する評価手法はどれか。", "choices": [{"label": "ア", "text": "負荷テスト"}, {"label": "イ", "text": "回帰テスト"}, {"label": "ウ", "text": "ホワイトボックステスト"}, {"label": "エ", "text": "ユーザビリティテスト"}], "correct": "エ", "hint": "ユーザビリティテストは、実際の利用者にシステムを操作してもらうことで使い勝手の問題点を発見する評価手法である。"}, {"id": 34, "cat": "システム開発", "topic": "判定条件網羅の考え方", "q": "ホワイトボックステストにおいて、条件分岐の真偽の両方の結果を少なくとも1回ずつ実行するように設計する網羅基準はどれか。", "choices": [{"label": "ア", "text": "同値分割"}, {"label": "イ", "text": "判定条件網羅"}, {"label": "ウ", "text": "限界値分析"}, {"label": "エ", "text": "命令網羅"}], "correct": "イ", "hint": "判定条件網羅は、if文などの判定条件が真になる場合と偽になる場合の両方を少なくとも1回ずつテストする基準である。"}, {"id": 35, "cat": "システム開発", "topic": "ウォーターフォールモデルとアジャイルの違い", "q": "ウォーターフォールモデルと比較したアジャイル開発の特徴として適切なものはどれか。", "choices": [{"label": "ア", "text": "文書化を最も重視する開発手法である"}, {"label": "イ", "text": "短い期間で開発とリリースを繰り返し、変化に柔軟に対応する"}, {"label": "ウ", "text": "工程の後戻りを一切想定しない"}, {"label": "エ", "text": "要件を全て確定させてから一括で開発を進める"}], "correct": "イ", "hint": "アジャイル開発は、短い反復(イテレーション)で開発とリリースを繰り返し、要求の変化に柔軟に対応することを特徴とする。"}, {"id": 36, "cat": "システム開発", "topic": "コードレビューの目的", "q": "開発チームで実施するコードレビューの主な目的として適切なものはどれか。", "choices": [{"label": "ア", "text": "開発者の勤務時間を記録すること"}, {"label": "イ", "text": "コーディング標準の遵守やバグを早期に発見すること"}, {"label": "ウ", "text": "テストを完全に省略できるようにすること"}, {"label": "エ", "text": "ソースコードの著作権を主張すること"}], "correct": "イ", "hint": "コードレビューは、他の開発者がコードを確認することでバグやコーディング標準からの逸脱を早期に発見する活動である。"}, {"id": 37, "cat": "システム開発", "topic": "バージョン管理システムの効果", "q": "複数人でソフトウェア開発を行う際に、Gitなどのバージョン管理システムを利用する効果として適切なものはどれか。", "choices": [{"label": "ア", "text": "変更履歴を管理し、複数人での並行開発や過去の状態への復元を容易にする"}, {"label": "イ", "text": "要件定義を自動化する"}, {"label": "ウ", "text": "テストケースを自動的に生成する"}, {"label": "エ", "text": "プログラムの実行速度を自動的に高速化する"}], "correct": "ア", "hint": "バージョン管理システムは、変更履歴を記録し、複数人での並行開発や過去のバージョンへの復元を容易にする。"}, {"id": 38, "cat": "システム開発", "topic": "ファンクションポイント法の計算", "q": "あるシステムの外部入力が3個(1個当たりの重み4)、外部出力が2個(1個当たりの重み5)、内部論理ファイルが1個(重み10)であるとき、未調整ファンクションポイントの合計はどれか。", "choices": [{"label": "ア", "text": "38"}, {"label": "イ", "text": "32"}, {"label": "ウ", "text": "28"}, {"label": "エ", "text": "22"}], "correct": "イ", "hint": "3×4+2×5+1×10=12+10+10=32ファンクションポイントになる。"}, {"id": 39, "cat": "プロジェクトマネジメント", "topic": "PERTの3点見積りによる期待値計算", "q": "ある作業の所要日数について、楽観値4日、最頻値6日、悲観値14日と見積もられた。PERTの計算式による期待値は何日か。", "choices": [{"label": "ア", "text": "9"}, {"label": "イ", "text": "8"}, {"label": "ウ", "text": "6"}, {"label": "エ", "text": "7"}], "correct": "エ", "hint": "PERTの期待値=(楽観値+4×最頻値+悲観値)÷6=(4+24+14)÷6=42÷6=7日になる。"}, {"id": 40, "cat": "プロジェクトマネジメント", "topic": "クリティカルパスの特定", "q": "作業A(3日、先行作業なし)、B(5日、先行作業A)、C(4日、先行作業A)、D(2日、先行作業B・Cの両方完了後)から成るプロジェクトがある。このプロジェクトの最短所要日数は何日か。", "choices": [{"label": "ア", "text": "12"}, {"label": "イ", "text": "10"}, {"label": "ウ", "text": "14"}, {"label": "エ", "text": "9"}], "correct": "イ", "hint": "経路A→B→Dは3+5+2=10日、経路A→C→Dは3+4+2=9日であり、長い方の10日が全体の最短所要日数になる。"}, {"id": 41, "cat": "プロジェクトマネジメント", "topic": "EVMによるコスト差異とスケジュール差異", "q": "あるプロジェクトの計画価値(PV)が100万円、出来高価値(EV)が80万円、実コスト(AC)が90万円のとき、コスト差異(CV=EV-AC)とスケジュール差異(SV=EV-PV)の組み合わせとして正しいものはどれか。", "choices": [{"label": "ア", "text": "CV=-10万円、SV=-20万円(コスト超過・進捗遅延)"}, {"label": "イ", "text": "CV=+10万円、SV=+20万円(コスト削減・進捗先行)"}, {"label": "ウ", "text": "CV=0、SV=0"}, {"label": "エ", "text": "CV=-20万円、SV=-10万円"}], "correct": "ア", "hint": "CV=EV-AC=80-90=-10万円、SV=EV-PV=80-100=-20万円であり、いずれも負の値のためコスト超過かつ進捗遅延を示す。"}, {"id": 42, "cat": "プロジェクトマネジメント", "topic": "リスクの期待金額価値(EMV)の計算", "q": "発生確率20%、発生時の損失額500万円と見積もられたリスクの期待金額価値(EMV)はどれか。", "choices": [{"label": "ア", "text": "-20万円"}, {"label": "イ", "text": "100万円"}, {"label": "ウ", "text": "-100万円"}, {"label": "エ", "text": "-500万円"}], "correct": "ウ", "hint": "EMV=発生確率×影響額=0.2×(-500万円)=-100万円になる。"}, {"id": 43, "cat": "サービスマネジメント・監査", "topic": "SLA違反時の対応", "q": "サービス提供者がSLAで合意した目標値を達成できなかった場合に、一般的に行われることはどれか。", "choices": [{"label": "ア", "text": "原因分析と再発防止策の検討、必要に応じた是正措置の実施"}, {"label": "イ", "text": "顧客への報告を一切行わない"}, {"label": "ウ", "text": "SLAそのものを直ちに廃止する"}, {"label": "エ", "text": "サービスの提供を無条件に停止する"}], "correct": "ア", "hint": "SLA未達成の場合は、原因を分析し是正処置を講じるとともに、必要に応じて顧客へ報告することが一般的である。"}, {"id": 44, "cat": "サービスマネジメント・監査", "topic": "問題管理における既知の誤り(Known Error)", "q": "問題管理プロセスにおいて、根本原因と暫定的な回避策が特定された未解決の問題を何と呼ぶか。", "choices": [{"label": "ア", "text": "インシデント"}, {"label": "イ", "text": "変更要求(RFC)"}, {"label": "ウ", "text": "サービス要求"}, {"label": "エ", "text": "既知の誤り(Known Error)"}], "correct": "エ", "hint": "既知の誤り(Known Error)は、根本原因と回避策(ワークアラウンド)が判明しているが、恒久的な解決には至っていない問題を指す。"}, {"id": 45, "cat": "サービスマネジメント・監査", "topic": "システム監査のフォローアップ", "q": "システム監査人が監査報告書を提出した後に実施するフォローアップの内容として適切なものはどれか。", "choices": [{"label": "ア", "text": "監査対象システムの開発を代行する"}, {"label": "イ", "text": "監査結果を非公開のまま破棄する"}, {"label": "ウ", "text": "被監査部門の人事評価を行う"}, {"label": "エ", "text": "改善提案に基づく措置が適切かつ適時に実施されているかを確認する"}], "correct": "エ", "hint": "フォローアップでは、監査で指摘した改善提案や改善計画が実際に適切かつ適時に実施されているかを確認する。"}, {"id": 46, "cat": "経営・戦略・法務", "topic": "損益分岐点売上高の計算", "q": "固定費が300万円、変動費率が60%である場合、損益分岐点売上高はいくらか。", "choices": [{"label": "ア", "text": "480万円"}, {"label": "イ", "text": "750万円"}, {"label": "ウ", "text": "500万円"}, {"label": "エ", "text": "900万円"}], "correct": "イ", "hint": "損益分岐点売上高=固定費÷(1-変動費率)=300÷(1-0.6)=300÷0.4=750万円になる。"}, {"id": 47, "cat": "経営・戦略・法務", "topic": "在庫回転率の計算", "q": "年間売上原価が1,200万円、平均在庫金額が200万円である場合の在庫回転率は何回か。", "choices": [{"label": "ア", "text": "3回"}, {"label": "イ", "text": "6回"}, {"label": "ウ", "text": "4回"}, {"label": "エ", "text": "8回"}], "correct": "イ", "hint": "在庫回転率=売上原価÷平均在庫金額=1,200÷200=6回になる。"}, {"id": 48, "cat": "経営・戦略・法務", "topic": "特許権と著作権の違い", "q": "特許権と著作権の違いに関する説明として適切なものはどれか。", "choices": [{"label": "ア", "text": "両方とも登録なしに自動的に発生する"}, {"label": "イ", "text": "特許権は出願・審査を経て発生し、著作権は創作した時点で自動的に発生する"}, {"label": "ウ", "text": "両方とも出願・審査が必須である"}, {"label": "エ", "text": "著作権は出願・審査を経て発生し、特許権は自動的に発生する"}], "correct": "イ", "hint": "特許権は特許庁への出願と審査を経て権利が発生するのに対し、著作権は創作した時点で自動的に発生する無方式主義を採る。"}, {"id": 49, "cat": "経営・戦略・法務", "topic": "下請法の趣旨", "q": "下請法(下請代金支払遅延等防止法)の主な目的として適切なものはどれか。", "choices": [{"label": "ア", "text": "特許権の存続期間を延長すること"}, {"label": "イ", "text": "個人情報の第三者提供を制限すること"}, {"label": "ウ", "text": "下請事業者の労働時間を管理すること"}, {"label": "エ", "text": "発注者と下請事業者との取引の公正化を図り、下請事業者の利益を保護すること"}], "correct": "エ", "hint": "下請法は、親事業者と下請事業者との取引の公正化を図り、下請事業者の利益を保護することを目的とした法律である。"}, {"id": 50, "cat": "経営・戦略・法務", "topic": "ROI(投資利益率)の計算", "q": "500万円を投資し、その結果として年間100万円の利益を得た場合のROI(投資利益率)はどれか。", "choices": [{"label": "ア", "text": "20%"}, {"label": "イ", "text": "5%"}, {"label": "ウ", "text": "10%"}, {"label": "エ", "text": "50%"}], "correct": "ア", "hint": "ROI=利益÷投資額×100=100÷500×100=20%になる。"}];
    ...
    <div style={s.app}>
      ...
      <div style={s.container}>
        <header style={s.header}>
          ...
          <div style={s.sub}>基本情報技術者 — 50問内蔵(本試験想定問題)</div>
